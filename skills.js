...
document.getElementById(elementName).innerHTML +=  
	'<div class="card-header">' +
        '<a class="card-link" onclick="addDetails('+index+')" data-toggle="collapse" href="#collapse' +index+'">'+
          '<img src="./rskills/' + imgSrc + '" class="ui medium image">' +
        '</a>'+
      '</div>'
	 if(index %5 == 0){
...
function getSkill(index){
  ...
  'C++ : Learned Basics of Programming and Algorithms and did numerous projects like : Telephone Directory Management, Flight cost minimizer using graphs',
  ...
  'GIT: Daily use for code management, Handled it effectively for projects involving millions of lines of code and files',
  ...
  'Javascript: Personal favourite. 2+ years of handson experience in various javascript applications. Oracle service cloud front end for single page application using knockout js, jquery, pure javascript.'+
...
'Managing service workers.\n Closely follow all developments associated - familiar with core concepts and es6 , es+',
...
'Selenium: 2Years of automating hundreds of UI components/Scenarios for Oracle products. Experienced in using cucumber',
'SQL: Regularly use it in work. A number of mini projects in college and company level which extensively depended on sql database. ( Traffic management system, Blood bank database)',
